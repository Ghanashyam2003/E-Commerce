      ...
      >
        ...
        <div className='absolute inset-0 bg-black/60 md:rounded-2xl flex items-center justify-center'>
          <div className='text-center text-white px-4'>
            ...
            <button className='bg-red-500 hover:bg-red-600 text-white font-semibold py-3 px-6 rounded-full shadow-lg transition duration-300 transform hover:scale-105'>
              Shop Now
            </button>
          </div>
        </div>
